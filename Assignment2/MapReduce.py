...
class MyMapView(object):
    ...
    def create_view(self):
        # sydney_tweets = "function (doc) { var location = doc.place.full_name.split(','); if(location[0] == 'Sydney' || location[1] == ' Sydney'){ emit(doc.place.name, [doc.text, doc.coordinates, doc.place.place_type])}}"
