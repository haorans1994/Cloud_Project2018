      ...
      <div className="home">
        ...
        <div className="team">
          ...
          <div className="team-overlay">
            <div className="name" style={{ top: '60%', left: '10%' }}>
              <Fly>
                <div>Niu Tong</div>
                <div className="student-id">811179</div>
              </Fly>
            </div>
            <div className="name" style={{ top: '65%', left: '22%' }}>
              <Fly>
                <div>Yunpeng Shao</div>
                <div className="student-id">854611</div>
              </Fly>
            </div>
            <div className="name" style={{ top: '63%', left: '44%' }}>
              <Fly>
                <div>
                  Qingqian
            ...
            <div className="name" style={{ top: '58%', left: '80%' }}>
              <Fly>
                <div>Haoran Sun</div>
